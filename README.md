...
- [Plitun](https://github.com/bjdgyc/plitun)
...
```bash
xattr -r -d com.apple.quarantine plitun-*.dmg
```
...
You should use `plitun-linux-amd64.tar.gz` with Ubuntu 20.04 or newer.

```bash
tar -zxvf plitun-*.tar.gz
```
